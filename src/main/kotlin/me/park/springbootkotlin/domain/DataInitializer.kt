...
class DataInitializer(
    ...
    fun initializeData() {
        ...
        val links = mutableListOf(
            Link(
                name = "Github",
                content = "https://github.com/mrpark219",
                isActive = true
            ),
            Link(
                name = "Linkedin",
                content = "https://www.linkedin.com/in/mrpark219",
                isActive = true
            )
        )
        ...
        // skill
        val java = Skill(name = "Java", type = LANGUAGE.name, isActive = true)
        val kotlin = Skill(name = "Kotlin", type = LANGUAGE.name, isActive = true)
        val python = Skill(name = "Python", type = LANGUAGE.name, isActive = true)
        val spring = Skill(name = "Spring", type = FRAMEWORK.name, isActive = true)
        val django = Skill(name = "Django", type = FRAMEWORK.name, isActive = true)
        val mysql = Skill(name = "MySQL", type = DATABASE.name, isActive = true)
        val redis = Skill(name = "Redis", type = DATABASE.name, isActive = true)
        val kafka = Skill(name = "Kafka", type = TOOL.name, isActive = true)
        ...
        project2.addDetails(
            mutableListOf(
                ...
                ProjectDetail(
                    ...
                    url = "https://github.com/mrpark219",
                    isActive = true
                )
            )
        )
